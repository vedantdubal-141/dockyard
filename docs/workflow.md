...
- **🛡️ Emergency Shutdown:** Pressing `Ctrl+C` while the app is live triggers an instant `docker compose down` sequence, ensuring no orphan containers are left behind.
